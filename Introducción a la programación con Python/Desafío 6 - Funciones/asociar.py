...
promVelocidad = promedio(velocidad)
promDistancia = promedio(distancia)

asociados = zip(velocidad, distancia)

# print(promVelocidad)
# print(promDistancia)

cnt = 0
for vel, dis in asociados:
    if vel < promVelocidad:
        cnt = cnt + 1
...
cnt = 0
for vel, dis in asociados:
    if vel < promVelocidad and dis > promDistancia:
        cnt = cnt + 1

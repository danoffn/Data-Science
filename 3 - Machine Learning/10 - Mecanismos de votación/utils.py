...
def get_graph(df, cols=4, var_numericas=[], var_categoricas=[], sub_width=5, sub_height=5):
    """
    grid_plot_batch: Genera una grilla con distintos tipos de gráficos para cada conjunto de variables. El
    tipo de gráfico dependerá del tipo de datos en la serie. Para datos numéricos, utiliza distplot;
    para datos categóricos utiliza countplot. La clasificación de tipo de datos se realiza automáticamente o puede 
    ser definida a usando una lista con var_categoricas o var_numericas
    ...
    Retorno:
        - Una grilla generada con sns.distplot y sns.countplot dependiendo del tipo de datos en la serie.
